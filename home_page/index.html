...
<body>
    ...
    <nav class="navbar navbar-expand">
        <div class="container-fluid d-flex justify-content-between">
            ...
            <div class="d-flex">
                <a class="nav-link" href="register_login/register.php">Sign up</a>
                <span class="mx-3">|</span>
                <a class="nav-link" href="register_login/login.php">Login</a>
              </div>
        ...
        <div class="row" style="color:white;">
            <div class="col" style="display:inline-flex;">
                <div class="circle" style="background-color: rgba(146, 15, 6); width: 100px; height: 100px; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 30px 20px 30px;">
                    <a href="booking.html" style="font-size: 15px; text-align: center; text-decoration: none; color:white;">Make a booking</a>
                </div>
                <div class="circle" style="background-color: rgba(146, 15, 6); width: 100px; height: 100px; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 30px 20px 30px;">
                    <a href="messaging.html" style="font-size: 15px; text-align: center; text-decoration: none; color:white;">Anonymous messaging</a>
                </div>
                <div class="circle" style="background-color: rgba(146, 15, 6); width: 100px; height: 100px; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 30px 20px 30px;">
                    <a href="resources.html" style="font-size: 15px; text-align: center; text-decoration: none; color:white;">Resources</a>
                </div>
                <div class="circle" style="background-color: rgba(146, 15, 6); width: 100px; height: 100px; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 30px 20px 30px;">
                    <a href="events.html" style="font-size: 15px; text-align: center; text-decoration: none; color:white;">Events</a>
                </div>
                <div class="circle" style="background-color: rgba(146, 15, 6); width: 100px; height: 100px; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 30px 20px 30px;">
                    <a href="blogs.html" style="font-size: 15px; text-align: center; text-decoration: none; color:white;">Blogs</a>
                </div>
            </div>
        </div>
    </div>
